...
[信息抽取介绍](#信息抽取介绍)<br>
&emsp;[关系抽取](#关系抽取)<br>
&emsp;&emsp;[关系抽取分类](#关系抽取分类) <br>
&emsp;&emsp;&emsp;[关系抽取方法分类](#关系抽取方法分类)<br>
&emsp;&emsp;&emsp;[训练数据的标记程度分类 ](#训练数据的标记程度分类 )<br>
&emsp;&emsp;&emsp;[是否在同一个模型里开展实体抽取和关系分类](#是否在同一个模型里开展实体抽取和关系分类)<br>
&emsp;&emsp;&emsp;[根据机器学习方法分类](#根据机器学习方法分类)<br>
&emsp;&emsp;[关系抽取深度学习模型](#关系抽取深度学习模型)<br>
&emsp;&emsp;&emsp;[基于递归神经网络的关系抽取](#基于递归神经网络的关系抽取)<br>
&emsp;&emsp;&emsp;[基于循环神经网络的关系抽取](#基于循环神经网络的关系抽取)<br>
&emsp;&emsp;&emsp;[基于卷积神经网络的关系抽取](#基于卷积神经网络的关系抽取)<br>
&emsp;&emsp;&emsp;[基于混合网络模型的关系抽取](#基于混合网络模型的关系抽取)<br>
&emsp;[实体抽取](#实体抽取)<br>
&emsp;[事件抽取](#事件抽取)<br>
